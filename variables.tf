...
variable "certificates" {
  ...
  default     = []
  description = "A list of certificates to upload to the Container App Environment. Each certificate needs a blob_base64 value, and optionally a name and password."
}
